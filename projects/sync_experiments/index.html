...
<body>
    ...
    <div class="muted">Sanitizer: убирает некорректные/невидимые символы, нормализует окончания строк и удаляет
        известные проблемные атрибуты SCTP.</div>

    <label>Синхронизируемое поле:</label>
    <input id="sharedInput" placeholder="Пишите текст — он будет отправлен по DataChannel" autocomplete="off" class="syncedinput" type="text" />
    ...
    <div style="margin-top:12px">
        <label>STUN servers (insert servers list like JS array - ["stun:server1:port1", "stun:server2:port2",
            "stun:server3:port3"]):</label>
